...
namespace FP31VecMathTest
{
	internal class Vec8uiTestValue
	{
		...
		//public Vec8uiTestValue(FPValues fPValues, VecMath2C vecMath2C)
		//{
		//	Vectors = fPValues;
		...
		//public Vec8uiTestValue(string number, int exponent, int precision, VecMath2C vecMath2C)
		//{
		...
		//public Vec8uiTestValue(Smx2C smx2CValue, VecMath2C vecMath2C)
		//{
