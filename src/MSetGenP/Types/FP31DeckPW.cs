...
namespace MSetGenP.Types
{
    public class FP31DeckPW : ICloneable
    {
        ...
        public Span<Vector256<ulong>> GetLimbVectorsUL(int limbIndex)
        {
            ...
            var result = MemoryMarshal.Cast<ulong, Vector256<ulong>>(x.Span);
        ...
        {
            var x = MantissaMemories[limbIndex];
            var result = MemoryMarshal.Cast<ulong, Vector256<uint>>(x.Span);
        ...
        {
            var result = new ulong[Mantissas.Length][];
