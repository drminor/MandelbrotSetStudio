...
namespace MSS.Types
{
	internal class ColorMapEntryHSB : IColorMapEntry
	{
		private const int BYTES_PER_PIXEL = 4;

		private readonly BlendValsHSB _blendVals;

		#region Constructor

		public ColorMapEntryHSB(ColorBand cb, bool useEscapeVelocities)
		...
		public ColorMapEntryHSB(int cutoff, ColorBandColor startColor, ColorBandBlendStyle blendStyle, ColorBandBlendMethod blendMethod, ColorBandColor endColor,
		...
		public int BlendAndPlace(double factor, Span<byte> destination)
		{
			...
			ColorHelper.PlaceHsb(hsl, destination);
		...
		public ColorMapEntryHSB Clone()
		{
			return new ColorMapEntryHSB(Cutoff, StartColor, BlendStyle, BlendMethod, EndColor, StartingCutoff, BucketWidth, UsingEscapeVelocities);
		}

		//private double[] GetHSB(byte[] cc)
		//{
