...
namespace EngineTest
{
	public class Smx2CTest
	{
		...
		public void RoundTrip_2C_ConvertExp_And_Convert_ToRValue_IsSuccessful()
		{
			...
			var aSmx = fpMathHelper.Convert(ScalarMathHelper.CreateSmx(aRValue, targetExponent, limbCount, bitsBeforeBP));
		...
		public void Create_Smx2C_WithMaxIntegerValue_Succeeds()
		{
			...
			var bRValue = new RValue(ScalarMathHelper.GetMax2CIntegerValue(bitsBeforeBP), 0);
