...
namespace PngImageLib
{
    ...
    ///
    ///
    /// All of the code in this project is licensed by Hernán J. González using the Apache 2.0 License.
    /// See the LICENSE.txt file in the DocsAndLicenseInfo folder for more information.
    /// See <c>DocsAndLicenseInfo.LICENSE.txt</c>/>
    /// </remarks>
    public class ImageLine
    {
        ...
        /// 
        /// To convert a indexed line to RGB values, see ImageLineHelper.PalIdx2RGB()
        /// (cant do the reverse)
        /// </remarks>
        public int[] Scanline { get; private set; }

        /// <summary>
        /// Same as Scanline, but with one byte per sample.
        /// Only one of Scanline and ScanlineB is valid - this depends on SampleType}
        /// </summary>
