...
namespace MSetGeneratorLib
{
	public static class MapSectionGenerator
	{
		...
		public static async Task<MapSectionResponse> GenerateMapSectionAsync(MapSectionRequest mapSectionRequest, IMapSectionAdapter mapSectionAdapter, CancellationToken ct)
		{
