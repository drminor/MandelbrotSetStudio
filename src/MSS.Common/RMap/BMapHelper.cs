...
namespace MSS.Common
{
	public static class BMapHelper
	{
		...
		public static BRectangle Zoom(BRectangle rRectangle)
		{
			...
			BRectangle rectangleWithNewExp;
			...
			if (remainderX == 0 && remainderY == 0)
			{
				...
				else
				{
					...
					rectangleWithNewExp = new BRectangle(Rebase(rRectangle.Values, -1), rRectangle.Exponent - 1);
			...
			else
			{
				...
				rectangleWithNewExp = new BRectangle(Rebase(rRectangle.Values, -2), rRectangle.Exponent - 2);
			...
			BRectangle result = new BRectangle(
