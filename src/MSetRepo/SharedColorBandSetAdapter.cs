...
namespace MSetRepo
{
	public class SharedColorBandSetAdapter
	{
		...
		public IEnumerable<ColorBandSetInfo> GetAllColorBandSetInfos()
		{
			...
			var result = allColorBandSetRecords.Select(x => new ColorBandSetInfo(x.Id, x.ColorBandRecords.Length, x.Name, x.Description));
		...
		public ColorBandSetInfo GetColorBandSetInfo(ObjectId id)
		{
			...
			var result = new ColorBandSetInfo(cbsRecord.Id, cbsRecord.ColorBandRecords.Length, cbsRecord.Name, cbsRecord.Description);
