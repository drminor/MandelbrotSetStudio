...
{
	public interface ICbsHistogramViewModel : IEquatable<ICbsHistogramViewModel?>
	{
		...
		SizeInt CanvasSize { get; set; }        // Size of display area in device independent pixels.
		SizeDbl ViewportSize { get; set; }		// Size of visible content
